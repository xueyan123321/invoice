<template>
  <div id="region">
    <input type="button" class="province-input" v-model="Province" @click="startInputProvince" required="required">
    <input type="button" class="city-input" v-model="City" @click="startInputCity" required="required">
    <input type="button" class="district-input" v-model="District" @click="startInputDistrict"  required="required" >
  ...
  export default {
    ...
    methods: {
      ...
      getProvinceId: function(code,input,index) {
        ...
        this.$emit('provinceSelected', input);
      },
      ...
      getDistrictId: function(code, input, index) {
        ...
        // 选取市区选项之后关闭弹层
        this.showChose = false;
        this.$emit('districtSelected', input);
      },
...
<style lang="scss"
  ...
  .province-input,.city-input,.district-input{
    width:30%;
    text-align: center;
  }
</style>
